...
# -------------------- Datasets --------------------
BLIP2_PROMPT = "Describe the image in detail, including colors and objects:"  # 也可用 "Describe the image in one short sentence."
...
def train(args):
    ...
    if args.use_lora:
        if is_blip2:
            ...
            # 2) Q-Former LoRA —— ★ 只包 qformer.bert，保持 Blip2QFormerModel 本体不变
